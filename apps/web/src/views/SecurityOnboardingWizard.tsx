          ...
          <div className="w-full max-w-2xl">
            ...
            <header className="mb-6 text-center sm:mb-8">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted sm:text-[15px]">
                Private Bitcoin-server grade setup: minimal identity data, strong cryptography, and recovery you control.
                  ...
                  <div>
                    <label htmlFor="master-pass" className="mb-1.5 flex items-center text-xs font-medium uppercase tracking-wide text-muted">
                      ...
                      <InfoTooltip
                        ...
                        text="Your password protects your private Bitcoin server. Choose a strong one."
                      />
                    </label>
                    <div className="relative">

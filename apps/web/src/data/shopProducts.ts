...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  {
    id: "phone-case",
    slug: "lightrain-phone-case-mist-pattern",
    name: "LightRain Phone Case (Mist Pattern)",
    tagline: "MagSafe ring aligned. TPU bumper, frosted back, drizzle topology.",
    description:
      "Fits current flagship profiles (select model at checkout). Camera ring raised 0.8 mm—table safe.",
    longDescription:
      "Mist pattern is lasered microtexture—not a print that peels. TPU corners with air gaps; back is PC frost for scratch resistance. Operator joke: it’s still a phone; don’t confuse the case for OPSEC.",
    materials: "TPU + PC hybrid, neodymium MagSafe array.",
    sizing: "Model-specific SKUs.",
    shippingNote: "Confirm device model before payment — variants not interchangeable.",
    care: "Remove monthly to clear pocket grit.",
    priceCents: 4500,
    category: "tech",
    availability: "in_stock",
    featured: false,
    ...
    popularity: 61,
    colors: [
      { id: "frost", label: "Frost Mist", hex: "#d4d4d8" },
      { id: "graphite", label: "Graphite", hex: "#3f3f46" },
    ],
    sizes: ["iPhone 15 Pro", "iPhone 15 Pro Max", "Pixel 8 Pro"],
    imageTone: "mist",
  },
  {
    id: "laptop-sleeve",
    slug: "lightrain-laptop-sleeve-stormshell",
    name: "LightRain Laptop Sleeve (StormShell)",
    tagline: "13\" and 16\" profiles. Magnetic flap, closed-cell foam.",
    description:
      "Waxed canvas face, microfiber interior, magnetic closure (no Velcro scream in meetings).",
    longDescription:
      "StormShell uses closed-cell foam lanes so impact does not travel to corners. Flap magnet strength tuned for one-hand open when holding coffee—details from people who actually commute.",
    materials: "Waxed canvas, neoprene core, microfiber lining, rare-earth magnets.",
    sizing: "13\" (fits ~304 mm width devices) / 16\" (~356 mm).",
    shippingNote: "Sleeve only; laptop obviously not included.",
    care: "Rewax canvas yearly; keep magnets away from magnetic stripe cards.",
    priceCents: 7900,
    category: "tech",
    availability: "in_stock",
    featured: false,
    limitedDrop: false,
    popularity: 63,
    colors: [{ id: "field", label: "Field Wax", hex: "#57534e" }],
    sizes: ['13"', '16"'],
    imageTone: "tan",
  },
  {
